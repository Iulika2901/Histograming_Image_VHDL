...
#
# Script generated by Vivado on Wed Nov 12 11:01:12 +0200 2025
...
simulate()
{
  xsim blk_mem_gen_1 -key {Behavioral:sim_1:Functional:blk_mem_gen_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
