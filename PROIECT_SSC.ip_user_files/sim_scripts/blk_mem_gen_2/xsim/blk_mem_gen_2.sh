...
#
# Script generated by Vivado on Wed Nov 12 11:03:16 +0200 2025
...
simulate()
{
  xsim blk_mem_gen_2 -key {Behavioral:sim_1:Functional:blk_mem_gen_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
