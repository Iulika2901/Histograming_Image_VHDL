...
HD_PWD='D:/C/fac3/sem1/ssc/PROIECT_SSC/PROIECT_SSC.runs/design_1_axi_bram_ctrl_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_bram_ctrl_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_bram_ctrl_2_1.tcl
