...
#
# Script generated by Vivado on Mon Nov 24 10:27:17 +0200 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_4 xil_defaultlib.blk_mem_gen_4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_4 -key {Behavioral:sim_1:Functional:blk_mem_gen_4} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
