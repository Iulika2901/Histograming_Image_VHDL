...
#
# Script generated by Vivado on Mon Nov 24 10:30:58 +0200 2025
...
# script info
echo -e "blk_mem_gen_5.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_5 xil_defaultlib.blk_mem_gen_5 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim blk_mem_gen_5 -key {Behavioral:sim_1:Functional:blk_mem_gen_5} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
